...
function getLedRecommendation(concerns: string[]) {
    if (concerns.includes("Acne-Prone") ||
        concerns.includes("Oily Skin / Blackheads")) {
        return {
            setting: "Blue Light (415nm) & Purple Light",
            details: "Blue light is clinically proven to target and destroy acne-causing bacteria beneath the skin surface. Alternate with Purple light to heal existing blemishes and prevent future breakouts.",
        };
    }
    if (concerns.includes("Early Signs of Aging") ||
        concerns.includes("Mature Skin")) {
        return {
            setting: "Red Light (633nm)",
            details: "Red light penetrates deep into the dermis to stimulate natural collagen production, reduce fine lines, and firm up sagging skin for a youthful appearance.",
        };
    }
    if (concerns.includes("Hyperpigmentation") ||
        ...
        return {
            ...
            details: "Green light breaks down melanin clusters to fade dark spots and even skin tone. White light accelerates skin metabolism for a radiant, healthy glow.",
        };
    }
    if (concerns.includes("Sensitive / Rosacea-prone")) {
        return {
            setting: "Cyan Light (490nm) & Yellow Light (590nm)",
            details: "Cyan reduces swollen capillaries and calms inflammation, while Yellow light flushes toxins and balances skin texture to relieve redness quickly.",
        };
    }
    return {
        setting: "Red Light (633nm)",
        details: "The gold standard for maintaining collagen levels, boosting hydration, and keeping your complexion healthy and radiant.",
    };
}
    ...
    switch (skinType) {
        case "Dry Skin":
            return {
                ...
                protect: "Apply a Hyaluronic Acid serum on damp skin to draw in moisture. Seal your routine with a rich ceramide cream to protect your barrier.",
            };
        case "Oily Skin":
            return {
                prep: "Double cleanse in the evenings.",
                protect: "Incorporate Niacinamide to regulate sebum production naturally, and finish with a lightweight, oil-free gel moisturizer.",
            };
        case "Combination Skin":
            return {
                prep: "Balance is key. Use a mild foaming cleanser.",
                protect: "Spot-treat your oily T-zone and apply a medium-weight lotion to your drier cheeks.",
            };
        default:
            return {
                prep: "Maintain your healthy barrier with a gentle cleanser.",
                protect: "Use a daily antioxidant serum, like Vitamin C, and SPF 50 every morning.",
            };
    }
}
...
export function buildSkincareQuizResult(answers: QuizAnswers): QuizResult {
    ...
    return {
        ...
        pregnancyWarning: answers.pregnant === "Yes"
        ...
        routine: [
            ...
            {
                number: "02",
                title: `${BRAND_NAME} LED Therapy (10 Mins)`,
