            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="store-display text-[14.5px] text-[var(--gold)] font-medium self-start mt-1">
          ...
          {product.included.map((item) => (
            ...
            >
              <span className="flex items-center gap-2 min-w-0">
                <span className="store-mono shrink-0 text-[var(--gold)] text-[11px]">{item.quantity}</span>
                <span className="text-[12px] sm:text-[13px] font-semibold text-[var(--plum)] truncate">
                  {item.label}
                </span>
              </span>
              {item.tag ? (
                <span className="store-mono shrink-0 rounded-full bg-[rgba(184,149,86,.18)] px-2 py-0.5 text-[10px] whitespace-nowrap text-[var(--plum)]">
                  {item.tag}
                </span>
              ) : null}
            </li>
