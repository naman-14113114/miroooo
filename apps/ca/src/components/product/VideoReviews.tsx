...
function ReviewVideoCard({
  ...
  return (
    ...
    >
      <video
        aria-label={
          "" + BRAND_NAME + " customer video review " + (index + 1) + ""
        }
...
export function VideoReviews() {
  return (
    <section className="store-section bg-[#f6ede2] pt-14 md:pt-24 pb-4 md:pb-6 overflow-hidden">
      <style>{`
        ...
        <SectionHeading
          ...
          title={
            <>
              {`
              ${BRAND_NAME} Mask `}
              <span className="store-italic text-[var(--gold)]">reviews</span>{" "}
              <span className="font-playfair italic text-[var(--plum)]">&</span>{" "}
              real results
            </>
          }
        />
