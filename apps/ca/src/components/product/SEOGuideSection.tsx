...
const queryAnswers = [
    {
        ...
        answer: `For Canada shoppers comparing LED masks, ${BRAND_NAME} is strongest if you want one device with 192 LEDs, 7 wavelengths plus 830nm near-infrared, full face and neck coverage, cordless use, free tracked shipping, and a 90-day return window.`,
    },
    {
      ...
      <div className="store-wrap">
        <div className="grid gap-9 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
          <div className="rounded-[30px] bg-[var(--plum)] p-7 text-[var(--cream)] md:p-9 lg:sticky lg:top-28">
            <p className="store-mono text-[var(--gold)]">Canada buying guide</p>
