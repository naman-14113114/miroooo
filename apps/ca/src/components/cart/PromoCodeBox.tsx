...
export function PromoCodeBox() {
    ...
    return (<div className="rounded-xl border border-[var(--border)] bg-[rgba(241,223,210,.35)] p-4">
      <div className="flex items-center justify-between gap-3">
        <div>
          <p className="store-mono text-[var(--gold)]">Promo code</p>
          <p className="mt-1 text-sm text-[var(--muted)]">
            {active
            ? "Applied automatically for product offers and free shipping."
            : `Add a ${BRAND_NAME} product to unlock the current offer.`}
          </p>
        </div>
