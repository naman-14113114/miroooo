...
export function organizationJsonLd() {
    return {
        ...
        name: BRAND_NAME,
        url: absoluteUrl("/"),
        logo: absoluteUrl("/media/products/miroooo-electric-toothbrush-x2/images/store-wordmark.png"),
        sameAs: [
...
export function websiteJsonLd() {
    return {
        ...
        potentialAction: {
            "@type": "SearchAction",
            target: `${absoluteUrl("/products/miroooo-electric-toothbrush-x2")}?q={search_term_string}`,
            "query-input": "required name=search_term_string",
        },
    };
}
export function guidePageJsonLd({ title, description, url, faqs, }: {
    title: string;
    description: string;
    url: string;
    faqs: FAQItem[];
    ...
    return [
        {
            ...
            about: [
                { "@type": "Thing", name: "Miroooo Electric Toothbrush" },
                { "@type": "Thing", name: "sonic toothbrush" },
                { "@type": "Thing", name: "portable electric toothbrush" },
                { "@type": "Thing", name: "aluminum body toothbrush" },
            ],
            mainEntity: {
                "@id": `${absoluteUrl("/products/miroooo-electric-toothbrush-x2")}#product`,
            },
        },
        faqJsonLd(faqs),
    ];
