...
export const metadata: Metadata = {
    ...
    description: `Update your ${BRAND_NAME} account settings.`,
    robots: {
        index: false,
        follow: false,
    },
...
export default async function AccountSettingsPage() {
    ...
    return (<section className="store-section bg-[var(--cream)] py-16 md:py-24">
      <div className="store-wrap">
        <div className="mb-10">
          <p className="store-eyebrow">Settings</p>
          <h1 className="store-heading mt-3">Account care.</h1>
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_360px]">
          ...
          <aside className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6 lg:sticky lg:top-24 lg:self-start">
            <p className="store-mono text-[var(--gold)]">Session</p>
