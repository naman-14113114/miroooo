...
const pageDescription = "A UK buyer's guide to choosing the best LED face mask for red light therapy, blue light acne routines, anti-ageing skincare, near-infrared support, neck coverage, and value.";
const checkpoints = [
    {
...
const comparisonRows = [
    ...
    ["UK offer", `${formatMoney(storeToothbrush.priceCents, storeToothbrush.currency)} launch price with free glow kit`],
    ...
    return (<>
      ...
      <section className="store-section bg-[var(--plum)] py-16 text-[var(--cream)] md:py-24">
        <div className="store-wrap grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            <p className="store-mono text-[var(--gold)]">UK LED mask guide</p>
          ...
          <figure className="relative min-h-[460px] overflow-hidden rounded-[34px] bg-[var(--ink)]">
            <Image alt={`${BRAND_NAME} LED Mask used at home in the UK`} className="object-cover" fill priority sizes="(min-width: 1024px) 48vw, 100vw" src="/images/products/buudy-led-mask/09-buudy-led-mask-home-spa.webp"/>
