  ...
  const badges = [
    {
      ...
      icon: "/media/products/miroooo-electric-toothbrush-x2/images/i3.png", // Truck
    },
    {
      title: "Dermatologist Reviewed",
      icon: "/media/products/miroooo-electric-toothbrush-x2/images/i4.png", // Shield
    },
    {
      title: "Buy Now, Pay Later Options Available",
      icon: "/media/products/miroooo-electric-toothbrush-x2/images/i2.png", // Drop with $
    },
    {
      title: "Proven Results, Backed By Science",
      icon: "/media/products/miroooo-electric-toothbrush-x2/images/i1.png", // Atom
    },
  ];
