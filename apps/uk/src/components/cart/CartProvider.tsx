...
const storageKey = "store-cart-v2";
const legacyStorageKey = "store-cart-v1";
export const checkoutSnapshotStorageKey = "store-cart-checkout-snapshot-v1";
...
function dispatchAddToCartEvent(product: Product) {
  ...
  window.dispatchEvent(
    new CustomEvent("store:add-to-cart", {
      detail: {
        product,
      },
    }),
