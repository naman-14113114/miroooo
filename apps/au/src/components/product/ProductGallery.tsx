    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Overlaid Badges */}
          {hasGifts && (
            <span className="store-mono absolute left-5 top-5 z-10 rounded-full bg-[var(--plum)] px-4 py-2 text-[var(--cream)] shadow-[0_10px_24px_-18px_rgba(58,31,61,.8)]">
              3 Free Gifts
            </span>
          )}
          <span className="absolute bottom-5 right-5 z-10 flex items-center gap-1.5 rounded-full bg-[rgba(247,241,232,.92)] px-3.5 py-2 text-[var(--plum)] shadow-[0_10px_24px_-18px_rgba(58,31,61,.55)]">
            ...
            <span className="store-mono leading-none">
              {market.madeInLabel}
            </span>
          </span>
