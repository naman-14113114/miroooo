...
export function PolicyPage({ policyType }: PolicyPageProps) {
  ...
  return (
    <div className="bg-[var(--cream)] min-h-screen py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="store-glow -left-24 top-12 h-[380px] w-[380px] bg-[#f4a17b] opacity-10" />
      <div className="store-glow -right-20 bottom-12 h-[420px] w-[420px] bg-[#a05080] opacity-10" />
      ...
      <div className="store-wrap relative z-10 max-w-4xl px-4 sm:px-6">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="store-mono text-[var(--gold)] tracking-[0.2em] uppercase text-xs font-semibold">
            Store Policies
          </p>
          <h1 className="store-display mt-3 text-[2.5rem] leading-[1.08] text-[var(--plum)] sm:text-5xl md:text-6xl font-light">
            {policy.title}
          </h1>
