# {{BRAND_NAME}} Country Store Monorepo

This repository is a pnpm/Turborepo monorepo for the {{BRAND_NAME}} country storefronts.
...
- Build command UK: `pnpm --filter @store/uk build`
- Build command US: `pnpm --filter @store/us build`
- Build command CA: `pnpm --filter @store/ca build`
- Build command AU: `pnpm --filter @store/au build`
